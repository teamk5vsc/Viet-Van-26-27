...
{
  "genre": "Tên tiếng Việt hiển thị của dạng bài (ví dụ: Kể chuyện sáng tạo)",
  ...
  "outline": {
    ...
    "thanbi": [
      {
        "point": "Ý chính của phần Thân bài (ví dụ: Diễn biến câu chuyện, Tả chi tiết...)",
    ...
    "ketbi": [
      {
        ...
        "detail": "Hướng dẫn cụ thể cách bộc lộ cảm xúc lắng đọng hoặc bài học ý nghĩa sâu sắc",
